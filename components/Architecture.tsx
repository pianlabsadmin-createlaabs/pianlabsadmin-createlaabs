    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="mx-auto w-full max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] items-center gap-14">
            ...
            <div className="w-full">
              ...
              <div className="space-y-5">
                {cards.map((card, idx) => (
                  ...
                  >
                    <div
                      className="rounded-2xl px-6 py-5 shadow-[0_14px_60px_rgba(0,0,0,0.55)] ring-1 ring-black/20"
                      style={{
                        background:
                          "linear-gradient(180deg, rgba(170,255,38,0.85) 0%, rgba(132,210,16,0.78) 100%)",
                      }}
                    >
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="hidden lg:flex items-center shrink-0">
                          <div className="flex items-center gap-2">
                            <div className="w-10 h-[2px] bg-[#5EFC0B]" />
                            <ArrowRight className="h-5 w-5 text-[#5EFC0B] translate-y-[0.5px]" />
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="relative w-full flex items-center justify-center lg:justify-end pointer-events-none">
              <motion.div
                ...
                style={{} as any}
                className="relative w-full aspect-square max-w-[720px] mx-auto translate-y-[155px] lg:mx-0 lg:translate-x-6"
              >
                <Image
                  ...
                  style={{ filter: "drop-shadow(0 28px 70px rgba(94,252,11,0.42))" }}
                />
              </motion.div>
            </div>
          </div>
